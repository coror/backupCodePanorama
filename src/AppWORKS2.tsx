...
//   const [initialOrientation, setInitialOrientation] = useState<Quaternion | null>(null);
...
//   const handleAlignmentConfirmed = useCallback((orientation: { quaternion: Quaternion; deviceOrientation: { alpha: number; beta: number; gamma: number } }) => {
//     setInitialOrientation(orientation.quaternion);
