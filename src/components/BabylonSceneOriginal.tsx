...
// const BabylonScene = ({ rotationTrigger: _rotationTrigger, direction: _direction, permissionsGranted = true, onSceneLoaded }: BabylonSceneProps) => {
...
//     let frozenQuaternion: Quaternion | null = null;
//     let isStill = false;
//     let stillCounter = 0;
...
//       // Detect if device is still - DEADZONE LOGIC
//       const stillnessThreshold = 0.004;
//       const unfreezeThreshold = 0.025;
      
//       if (speed < stillnessThreshold && RMS < 0.0002) {
//         stillCounter++;
//         if (stillCounter > 5) {
//           isStill = true;
//           if (frozenQuaternion === null) {
//             const finalQuat = averagedQuaternion.normalize();
//             finalQuat.multiplyInPlace(screenQuaternion);
//             finalQuat.multiplyInPlace(constantTransform);
//             finalQuat.z *= -1;
//             finalQuat.w *= -1;
//             frozenQuaternion = finalQuat.clone();
//           }
//         }
//       } else if (speed > unfreezeThreshold || RMS > 0.001) {
//         stillCounter = 0;
//         isStill = false;
...
//       if (isStill && frozenQuaternion) {
//         camera.rotationQuaternion = frozenQuaternion.clone();
//       } else {
...
//       engine.dispose();
//     };
//   }, [permissionsGranted, isManualMode]);
