...
//     // Listen for device orientation (NOT deviceorientationabsolute - we don't want compass)
...
//     const screenOrientationAngle = window.orientation !== undefined ? +(window.orientation) : 0;
...
//     // Debug logging
//     console.log('CameraAlignment - Raw angles:', { alpha, beta, gamma });
//     console.log('CameraAlignment - Screen orientation:', screenOrientationAngle);
//     console.log('CameraAlignment - Final quaternion:', {
//       x: finalQuaternion.x.toFixed(3),
//       y: finalQuaternion.y.toFixed(3),
//       z: finalQuaternion.z.toFixed(3),
//       w: finalQuaternion.w.toFixed(3)
//     });
